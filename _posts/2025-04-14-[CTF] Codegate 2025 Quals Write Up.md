...
![Image](/assets/img/04-14/codegate2025.png)
...
![Image](/assets/img/04-14/hello.png)
...
![Image](/assets/img/04-14/captcha.png)
...
![Image](/assets/img/04-14/ping.png)
...
![Image](/assets/img/04-14/ping_ex.png)
...
각 분야 별로 제일 쉬운 문제만 골라서 푸니 이렇게까지 CTF가 재밌다는 것을 처음으로 알았다. 운좋게 본선에 가게 되었으니 좋은 경험 갖고 오도록 노력해야겠다.